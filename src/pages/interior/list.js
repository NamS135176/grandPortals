...
const InteriorList = () => {
	...
	const getInteriorList = useCallback(async () => {
		try {
			const data = await bukkenApi.getInteriorList();
				...
				<Container maxWidth="xl">
					...
					<Card>
						<CardContent>
							...
							>
								<Typography variant="h6">建具・インテリア一覧</Typography>
								<Box>
									<Button variant="contained" sx={{ mr: 2 }}>
										既製品新規登録
									</Button>
									<Button variant="contained">オーダー製品新規登録</Button>
								</Box>
							</Box>
							<InteriorListTable
