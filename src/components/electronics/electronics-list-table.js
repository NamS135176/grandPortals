...
const applySort = (electronics, sortDir) =>
...
export const ElectronicsListTable = (props) => {
	const {
		electronics,
		electronicsCount,
		onPageChange,
	...
	const sortedBukken = applySort(electronics, sort);
							...
							return (
								<TableRow hover key={buk.id}>
									<TableCell align="right">
										<NextLink href="/electronics/normal/1" passHref>
											<Box
												sx={{
													alignItems: 'center',
													display: 'flex',
...
ElectronicsListTable.propTypes = {
	electronics: PropTypes.array.isRequired,
	electronicsCount: PropTypes.number.isRequired,
