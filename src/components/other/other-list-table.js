...
export const OtherListTable = (props) => {
	const {
		other,
		otherCount,
		onPageChange,
	...
	const sortedBukken = applySort(other, sort);
							...
							return (
								<TableRow hover key={buk.id}>
									<TableCell align="right">
										<NextLink href="/other/normal/1" passHref>
											<Box
												sx={{
													alignItems: 'center',
													display: 'flex',
