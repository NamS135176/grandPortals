...
const applySort = (exterior, sortDir) =>
	exterior.sort((a, b) => {
		let newOrder = 0;
...
export const ExteriorListTable = (props) => {
	const {
		exterior,
		exteriorCount,
		onPageChange,
	...
	const sortedBukken = applySort(exterior, sort);
							...
							return (
								<TableRow hover key={buk.id}>
									<TableCell align="right">
										<NextLink href="/exterior/1" passHref>
											<Box
												sx={{
													alignItems: 'center',
													display: 'flex',
...
ExteriorListTable.propTypes = {
	exterior: PropTypes.array.isRequired,
	exteriorCount: PropTypes.number.isRequired,
